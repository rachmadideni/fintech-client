  ...
  produce(state, (draft) => {
    switch (action.type) {
      ...
      case UPLOAD_ACTION:{
        ...
        if(found_index > -1)
        {
          draft.data.documents.uploaded[found_index].idberk = idberk;  
          draft.data.documents.uploaded[found_index].file = file;
          draft.data.documents.uploaded[found_index].objectURL = objectURL;
          ...
          draft.data.documents.uploaded = draft.data.documents.uploaded.concat(arr);
        }
